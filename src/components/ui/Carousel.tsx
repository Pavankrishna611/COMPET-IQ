...
import { ArrowRight, Sparkles, Layers, CheckSquare, BookOpen, Bot } from 'lucide-react';
import './Carousel.css';
...
const DEFAULT_ITEMS: CarouselItemData[] = [
  {
    ...
    description: 'Evaluate cadre competency & earn MoSPI digital certifications.',
  ...
  },
  {
    ...
    description: 'Explore verified NSSTA & iGOT statistical training curriculum.',
  ...
  {
    id: 3,
    title: 'AI Statistical Assistant',
    description: 'Query sampling methodologies, National Accounts & R/Python scripts.',
  ...
  {
    id: 4,
    title: 'Competency Gap Matrix',
    description: 'Identify critical cadre deficiencies and prioritize learning paths.',
    icon: <Layers className="carousel-icon" />,
    tag: 'INTELLIGENCE',
    href: '/learner/skill-gaps',
    btnText: 'View Skill Gaps',
  },
];
  ...
  const content = (
    <div className="w-full h-full flex flex-col justify-between select-none">
      <div className={`carousel-item-header ${round ? 'round' : ''}`}>
        ...
        {!round && item.tag && (
          <span className="carousel-tag-badge">{item.tag}</span>
        )}
      </div>
      ...
      <div className="carousel-item-content">
        ...
        {!round && (
          <div className="carousel-item-footer">
            <span className="carousel-action-btn">
              <span>{item.btnText || 'Launch Action'}</span>
